...
description: Exact field names and data structure returned by Blaze CareerMode export endpoints for Madden 26
---

## Key Findings

All Blaze CareerMode_Get*Export endpoints return **flat arrays**, NOT nested objects.
...
### Rosters: CareerMode_GetTeamRostersExport
