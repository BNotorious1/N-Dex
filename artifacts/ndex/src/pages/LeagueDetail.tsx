      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          <div className="px-6 py-6">
            {section === "home" && (
              <HomeSection summary={summary} leagueId={leagueId} statLeaders={statLeaders} standings={standings} gotw={gotw} onNavigate={setSection as (s: string) => void} isMember={isMember} />
            )}
